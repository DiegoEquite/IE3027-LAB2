...
SOURCEFILES_QUOTED_IF_SPACED=Lab2.c ADC.c 7segmentos.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Lab2.p1 ${OBJECTDIR}/ADC.p1 ${OBJECTDIR}/7segmentos.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/Lab2.p1.d ${OBJECTDIR}/ADC.p1.d ${OBJECTDIR}/7segmentos.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Lab2.p1 ${OBJECTDIR}/ADC.p1 ${OBJECTDIR}/7segmentos.p1

# Source Files
SOURCEFILES=Lab2.c ADC.c 7segmentos.c
...
${OBJECTDIR}/7segmentos.p1: 7segmentos.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/7segmentos.p1 7segmentos.c 
	@-${MV} ${OBJECTDIR}/7segmentos.d ${OBJECTDIR}/7segmentos.p1.d 
